/******/ (() => {
	...
	(() => {
		...
		// EXTERNAL MODULE: ./src/js/components/next-hidden.js
		var next_hidden = __webpack_require__(393);
		// EXTERNAL MODULE: ./src/js/components/copying-row.js
		var copying_row = __webpack_require__(863);
		// EXTERNAL MODULE: ./src/js/components/form.js
		var components_form = __webpack_require__(907); // CONCATENATED MODULE: ./node_modules/ssr-window/ssr-window.esm.js
		/**
		 * SSR Window 4.0.2
    ...
    support
      ...
      `;
		...
		} // CONCATENATED MODULE: ./node_modules/swiper/swiper.esm.js // CONCATENATED MODULE: ./src/js/components/result-sliders.js
		/**
		 * Swiper 7.4.1
		...
		if (resultSection) {
			...
			resultSliders.forEach((sliderNode, idx) => {
				...
				let slider = new core(sliderNode, {
					speed: 400,
					spaceBetween: 0,
					grabCursor: true,
					loop: true,
